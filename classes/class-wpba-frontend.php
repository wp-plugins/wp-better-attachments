...
class WPBA_Frontend extends WP_Better_Attachments
{
	 ...
	 *  @type string 'image_icon'           Default: "{$plugin_url}/assets/img/image-icon.png"
	 *  @type string 'file_icon'            Default: "{$plugin_url}/assets/img/file-icon.png"
	 *  @type string 'audio_icon'           Default: "{$plugin_url}/assets/img/audio-icon.png"
	 *  @type string 'video_icon'           Default: "{$plugin_url}/assets/img/video-icon.png"
